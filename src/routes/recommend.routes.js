...
import { get_bodyinfo_all, get_bodyinfo_by_uuid, get_member_by_uuid, get_userfit_by_uuid, get_userstyle_by_uuid, recommend_bodyinfo_by_uuid, recommend_style_by_uuid } from "../domains/recommend/recommend.controller.js"
...
// 추천: 모든 사용자 체형정보 얻기
recommendRouter.get('/getbodyinfo/', asyncHandler(get_bodyinfo_all));
